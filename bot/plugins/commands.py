    ...
    if update_channel:
        try:
            ...
            await update.reply_text(
                text=" ചാനലിൽ നിങ്ങൾ ഉണ്ടെങ്കിൽ മാത്രമേ ഈ ബോട്ട് വഴി നിങ്ങൾക്ക് സിനിമ കിട്ടുകയുള്ളൂ അതുകൊണ്ട് ചാനലിൽ ജോയിൻ ചെയ്യുക എന്നിട്ട് വീണ്ടും ഗ്രൂപ്പിൽ പോയി മൂവിയിൽ ക്ലിക്ക് ചെയ്തു START കൊടുക്കുക💞",
                reply_markup=InlineKeyboardMarkup([
                    [ InlineKeyboardButton(text="♦️Join Channel♦️", url=f"https://t.me/{update_channel}")]
              ])
            )
            return
